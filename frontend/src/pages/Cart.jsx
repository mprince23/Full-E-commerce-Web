      ...
      <div className="py-10">
              ...
              if (cartItems[product._id] > 0) {
                return (
                  ...
                  >
                    ...
                    <td className="p-1 line-clamp-3">
                      <dir>{product.name}</dir>
                    </td>
        ...
        <div className="flex flex-col xl:flex-row gap-20 mt-20">
          ...
          <div className="flex flex-1 flex-col gap-8">
            <h4 className="bold-20 capitalize">Your coupon enter here : </h4>
            <div className="flexBetween h-[2.8rem] bg-primary right-1 ring-slate-900/10 w-full max-w-[488px] rounded">
              <input
                type="text"
